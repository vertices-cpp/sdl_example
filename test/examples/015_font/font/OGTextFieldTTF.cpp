...
bool TextFieldDelegate::onVisit(TextFieldTTF* /*sender*/, SDL_Renderer* /*renderer*/, const Mat3& /*transform*/, uint32_t /*flags*/)
{
    return false;
}
...
void TextFieldTTF::visit(SDL_Renderer *renderer, const Mat3 &parentTransform, uint32_t parentFlags)
{
