 ...
 */
class LabelLetter :   public Ref,public Sprite
{
public:
    LabelLetter()
    {
    ...
    virtual void updateTransform() override
    {
        if (isDirty())
        {
            ...
            _quad.bl.vertices.set((ax), (ay));
            _quad.br.vertices.set((bx), (by));
            _quad.tl.vertices.set((dx), (dy));
            _quad.tr.vertices.set((cx), (cy));
    ...
    void draw(SDL_Renderer* /*renderer*/, const Mat3 & /*transform*/, uint32_t /*flags*/) override
    {
    }
