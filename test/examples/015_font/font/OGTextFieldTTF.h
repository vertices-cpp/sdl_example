...
public: 
    ...
    virtual bool onVisit(TextFieldTTF* sender, SDL_Renderer* renderer, const Mat3& transform, uint32_t flags);
}; 
...
public: 
    ...
    virtual void visit(SDL_Renderer *renderer, const Mat3 &parentTransform, uint32_t parentFlags) override;
